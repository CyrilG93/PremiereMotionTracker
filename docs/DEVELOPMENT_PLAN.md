...
- OpenCV est relié au module Hybrid Windows pour inspecter un média via Media Foundation ; le décodage image par image et le flux optique restent à intégrer.
