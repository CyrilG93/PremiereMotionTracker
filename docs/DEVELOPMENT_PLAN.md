...
- Version 0.5.4 : l’aperçu essaye d’abord le fichier média original via une URL locale `file:/`, sans rendu H.264 temporaire. Il expose les événements complets du lecteur dans Diagnostics et retombe sur une image Premiere si UXP ne peint pas la vidéo. Cette voie reste à valider dans Premiere sur Windows et macOS.
