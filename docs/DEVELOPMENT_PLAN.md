...
- Version 0.5.7 : pendant le tracking point, OpenCV écrit les PNG 960 px du cache de preview directement depuis son décodage séquentiel déjà actif. Le slider et Play relisent ensuite ces images sans seek Media Foundation ni export Premiere. Cette voie reste à valider dans Premiere sur Windows et macOS.
