...
3. Une fois l’aperçu préparé, les images sont chargées avant la lecture. Cliquez sur `Play` / `Pause`, utilisez `Start`, `− frame` et `+ frame` pour vérifier le point superposé avant de modifier le projet.
