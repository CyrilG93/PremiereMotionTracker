...
- Version 0.5.5 : l’aperçu ne dépend plus de la surface `<video>` UXP. OpenCV décode directement l’image demandée du média original, l’écrit dans le dossier temporaire UXP, puis le panneau affiche ce PNG et son overlay ; aucune exportation d’images par Premiere n’est nécessaire. Cette voie reste à valider dans Premiere sur Windows et macOS.
